       ...
       CancellationToken cancellationToken)
        {
            ...
            switch (subscriptionAction)
            {
                ...
                case ActionsEnum.Unsubscribe:
                    var mailLinkController = new MailLinkController(this.fulfillmentClient);
                    ...
                    return unsubscribeResult.Success ? this.RedirectToAction("Index") : (ActionResult)mailLinkController.View("../MailLink/MailActionError", FulfillmentRequestErrorViewModel.From(unsubscribeResult)); ;
       ...
       CancellationToken cancellationToken)
        {
           ...
           .Any(o => o.Status == OperationStatusEnum.InProgress)) return this.RedirectToAction("Index");
            ...
            correlationId,
            cancellationToken);
            return updateResult.Success ? this.RedirectToAction("Index") : (ActionResult)mailLinkController.View("../MailLink/MailActionError", FulfillmentRequestErrorViewModel.From(updateResult));
        }
