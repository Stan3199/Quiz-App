    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddFulfillmentClient(options => this.configuration.Bind("FulfillmentClient", options))
                ...
                //.WithAzureTableOperationsStore(this.configuration.GetValue<string>("FulfillmentClient:OperationsStoreConnectionString"));
            ...
            services.AddSingleton<TextAnalyticsPortalWebhookHandlerOptions>();

            services.AddWebhookProcessor().WithWebhookHandler<TextAnalyticsPortalWebhookHandler>();
