namespace TextAnalyticsPortal
{
    ...
    public class TextAnalyticsPortalWebhookHandler : IWebhookHandler
    {
        private readonly IMarketplaceNotificationHandler notificationHelper;

        public TextAnalyticsPortalWebhookHandler(IMarketplaceNotificationHandler notificationHelper)
        {
